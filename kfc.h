...
public:
    ...
    KImageGray BinaryErode(const int& nType, const int& kernelSize, const int& neighborType);
    KImageGray BinaryDilate(const int& nType, const int& kernelSize, const int& neighborType);

    KImageGray Opening(const int& nType, const int& kernelSize, const int& neighborType);
    KImageGray Closing(const int& nType, const int& kernelSize, const int& neighborType);

    static KImageGray SubtractImages(const KImageGray& img1, const KImageGray& img2);
